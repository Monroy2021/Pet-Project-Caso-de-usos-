...
public class Compra extends AggregateEvent<CompraId> {
    ...
    public Compra(CompraId compraId, CarnetId clienteId, Map<LibroCod, Precio> listaLibros, ValorTotal valorTotal, ReciboId reciboId, VendedorId vendedorId, CajaId cajaId, FechaRecibo fechaRecibo) {
        super(compraId);
...
private Compra(CompraId compraId){
    ...
    GenerarRecibo(CompraId id, CarnetId clienteId, Map<LibroCod, Precio> listaLibros, ValorTotal valorTotal,ReciboId reciboId, VendedorId vendedorId,CajaId cajaId){
  appendChange(new ReciboGenerado(id,clienteId,listaLibros,valorTotal, reciboId, vendedorId, cajaId, fechaRecibo)).apply();
    }
    public void AsignarCliente(CarnetId clienteId){
